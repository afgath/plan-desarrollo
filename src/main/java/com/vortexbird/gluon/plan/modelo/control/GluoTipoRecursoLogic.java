...
public class GluoTipoRecursoLogic implements IGluoTipoRecursoLogic {
    ...
    */
    ...
    public List<GluoTipoRecursoDTO> getDataGluoTipoRecurso()
        ...
        try {
            ...
            for (GluoTipoRecurso gluoTipoRecursoTmp : gluoTipoRecurso) {
                GluoTipoRecursoDTO gluoTipoRecursoDTO2 = gluoTipoRecursoMapper.gluoTipoRecursoToGluoTipoRecursoDTO(gluoTipoRecursoTmp);
    ...
    public List<GluoTipoRecurso> findPageGluoTipoRecurso(
        ...
        try {
            entity = gluoTipoRecursoDAO.findPage(sortColumnName, sortAscending,
                    startRow, maxResults);
        } catch (Exception e) {
            throw new ZMessManager().new FindingException(
                "GluoTipoRecurso Count");
        } finally {
        }
