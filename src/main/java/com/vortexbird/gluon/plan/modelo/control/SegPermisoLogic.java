...
public class SegPermisoLogic implements ISegPermisoLogic {
    ...
    */
    ...
    public void validateSegPermiso(SegPermiso segPermiso)
        throws Exception {
        try {
            Set<ConstraintViolation<SegPermiso>> constraintViolations = validator.validate(segPermiso);

            if (constraintViolations.size() > 0) {
                StringBuilder strMessage = new StringBuilder();

                for (ConstraintViolation<SegPermiso> constraintViolation : constraintViolations) {
    ...
    public void saveSegPermiso(SegPermiso entity) throws Exception {
        ...
        try {
            ...
            validateSegPermiso(entity);

            if (getSegPermiso(entity.getPermId()) != null) {
    ...
    public void deleteSegPermiso(SegPermiso entity) throws Exception {
        ...
        if (entity.getPermId() == null) {
            throw new ZMessManager().new EmptyFieldException("permId");
        }
    ...
    public List<SegPermisoDTO> getDataSegPermiso() throws Exception {
        try {
            ...
            for (SegPermiso segPermisoTmp : segPermiso) {
                SegPermisoDTO segPermisoDTO2 = segPermisoMapper.segPermisoToSegPermisoDTO(segPermisoTmp);
    ...
    public SegPermiso getSegPermiso(Integer permId) throws Exception {
        ...
        try {
            entity = segPermisoDAO.findById(permId);
        } catch (Exception e) {
