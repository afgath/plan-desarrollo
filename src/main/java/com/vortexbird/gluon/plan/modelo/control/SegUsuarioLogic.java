...
public class SegUsuarioLogic implements ISegUsuarioLogic {
    ...
    */
    ...
    public void validateSegUsuario(SegUsuario segUsuario)
        throws Exception {
        try {
            Set<ConstraintViolation<SegUsuario>> constraintViolations = validator.validate(segUsuario);

            if (constraintViolations.size() > 0) {
                StringBuilder strMessage = new StringBuilder();

                for (ConstraintViolation<SegUsuario> constraintViolation : constraintViolations) {
...
//            }
    ...
    public void deleteSegUsuario(SegUsuario entity) throws Exception {
        ...
        try {
            segRolUsuarios = segRolUsuarioDAO.findByProperty("segUsuario.usuId",
                    entity.getUsuId());
    ...
    public void updateSegUsuario(SegUsuario entity) throws Exception {
        ...
        try {
            ...
            if(entity.getUsuId()==entity.getUsuModificador()){
            	throw new Exception("El usuario no se puede modificar a si mismo");
            }
    ...
    public List<SegUsuarioDTO> getDataSegUsuario() throws Exception {
        try {
            ...
            for (SegUsuario segUsuarioTmp : segUsuario) {
                SegUsuarioDTO segUsuarioDTO2 = segUsuarioMapper.segUsuarioToSegUsuarioDTO(segUsuarioTmp);
    ...
    public SegUsuario getSegUsuario(Integer usuId) throws Exception {
        ...
        try {
            entity = segUsuarioDAO.findById(usuId);
        } catch (Exception e) {
    ...
    public List<SegUsuario> findPageSegUsuario(String sortColumnName,
        ...
        try {
            entity = segUsuarioDAO.findPage(sortColumnName, sortAscending,
                    startRow, maxResults);
        } catch (Exception e) {
