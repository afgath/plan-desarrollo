...
public class GluoIndicadorLogic implements IGluoIndicadorLogic {
	...
	public void validateGluoIndicador(GluoIndicador gluoIndicador) throws Exception {
		try {
	...
	public void saveGluoIndicador(GluoIndicador entity) throws Exception {
	...
	@Transactional(readOnly = false, propagation = Propagation.REQUIRED)
	public void deleteGluoIndicador(GluoIndicador entity) throws Exception {
		...
		try {
			...
			if (Utilities.validationsList(gluoHistorialIndicadors) == true) {
				throw new ZMessManager().new DeletingException("gluoHistorialIndicadors");
			}
	...
	@Transactional(readOnly = false, propagation = Propagation.REQUIRED)
	public void updateGluoIndicador(GluoIndicador entity) throws Exception {
	...
	@Transactional(readOnly = true)
	public List<GluoIndicadorDTO> getDataGluoIndicador() throws Exception {
		try {
			...
			for (GluoIndicador gluoIndicadorTmp : gluoIndicador) {
				GluoIndicadorDTO gluoIndicadorDTO2 = gluoIndicadorMapper
						.gluoIndicadorToGluoIndicadorDTO(gluoIndicadorTmp);
	...
	@Transactional(readOnly = true)
	public GluoIndicador getGluoIndicador(Integer indiId) throws Exception {
	...
	@Transactional(readOnly = true)
	public List<GluoIndicador> findPageGluoIndicador(String sortColumnName, boolean sortAscending, int startRow,
			int maxResults) throws Exception {
		List<GluoIndicador> entity = null;

		try {
			entity = gluoIndicadorDAO.findPage(sortColumnName, sortAscending, startRow, maxResults);
		} catch (Exception e) {
	 ...
	 */
	@Transactional(readOnly = true)
	public List<GluoIndicador> findByCriteria(Object[] variables, Object[] variablesBetween,
	...
	public List<GluoIndicador> find(String query) {
		...
		return gluoIndicadorDAO.find(query);
	}
}
