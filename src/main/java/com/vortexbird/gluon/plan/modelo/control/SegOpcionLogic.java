...
public class SegOpcionLogic implements ISegOpcionLogic {
    ...
    */
    ...
    public void validateSegOpcion(SegOpcion segOpcion)
        throws Exception {
        try {
            Set<ConstraintViolation<SegOpcion>> constraintViolations = validator.validate(segOpcion);

            if (constraintViolations.size() > 0) {
                StringBuilder strMessage = new StringBuilder();

                for (ConstraintViolation<SegOpcion> constraintViolation : constraintViolations) {
    ...
    public void saveSegOpcion(SegOpcion entity) throws Exception {
        ...
        try {
            ...
            validateSegOpcion(entity);

            if (getSegOpcion(entity.getOpcnId()) != null) {
    ...
    public void deleteSegOpcion(SegOpcion entity) throws Exception {
        ...
        if (entity.getOpcnId() == null) {
            throw new ZMessManager().new EmptyFieldException("opcnId");
        }

        List<SegPermiso> segPermisos = null;

        try {
            segPermisos = segPermisoDAO.findByProperty("segOpcion.opcnId",
                    entity.getOpcnId());
    ...
    public List<SegOpcionDTO> getDataSegOpcion() throws Exception {
        try {
            ...
            for (SegOpcion segOpcionTmp : segOpcion) {
                SegOpcionDTO segOpcionDTO2 = segOpcionMapper.segOpcionToSegOpcionDTO(segOpcionTmp);
    ...
    public SegOpcion getSegOpcion(Integer opcnId) throws Exception {
        ...
        try {
            entity = segOpcionDAO.findById(opcnId);
        } catch (Exception e) {
