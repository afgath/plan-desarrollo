...
public class SegRolLogic implements ISegRolLogic {
    ...
    */
    ...
    public void validateSegRol(SegRol segRol) throws Exception {
        try {
            Set<ConstraintViolation<SegRol>> constraintViolations = validator.validate(segRol);

            if (constraintViolations.size() > 0) {
                StringBuilder strMessage = new StringBuilder();

                for (ConstraintViolation<SegRol> constraintViolation : constraintViolations) {
    ...
    public void saveSegRol(SegRol entity) throws Exception {
        ...
        try {
            ...
            validateSegRol(entity);

            if (getSegRol(entity.getRolId()) != null) {
    ...
    public void deleteSegRol(SegRol entity) throws Exception {
        ...
        try {
            segRolUsuarios = segRolUsuarioDAO.findByProperty("segRol.rolId",
                    entity.getRolId());
    ...
    public List<SegRolDTO> getDataSegRol() throws Exception {
        try {
            ...
            for (SegRol segRolTmp : segRol) {
                SegRolDTO segRolDTO2 = segRolMapper.segRolToSegRolDTO(segRolTmp);
    ...
    public SegRol getSegRol(Integer rolId) throws Exception {
        ...
        try {
            entity = segRolDAO.findById(rolId);
        } catch (Exception e) {
